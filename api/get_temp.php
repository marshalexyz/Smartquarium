...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $query = "SELECT 
                ...
                COUNT(temperatur) AS total_max_temperature,
                MAX(temperatur) AS max_temp
            FROM
                data_sensor
            WHERE
                temperatur = (SELECT MAX(temperatur) FROM data_sensor AS sub WHERE EXTRACT(YEAR_MONTH FROM sub.timestamp) = EXTRACT(YEAR_MONTH FROM data_sensor.timestamp))
