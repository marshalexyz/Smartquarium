    ...
    <main class="flex-1 lg:pl-[224px]">
      ...
      <header class="flex w-full items-center justify-between px-[40px] py-[10px] fixed bg-white shadow-sm dark:bg-dark-primary lg:relative transition-all duration-150 ease-in-out">
        <div class="w-[175px] sm:w-[260px]">
          <h1 class="font-semibold text-2xl text-primary sm:text-3xl lg:text-4xl dark:text-slate-200">About Dev</h1>
          <p class="font-normal text-[12px] text-primary sm:text-md lg:text-[14px] dark:text-dark-fourth">Information about developer.</p>
        </div>
        <div class="">
        ...
        <div class="w-full h-full p-10 mb-5 bg-white rounded-[8px] border-b-4 border-primary dark:bg-dark-primary dark:border-logo-color">
          <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 ">
            <div class="w-full flex flex-col justify-between gap-2 lg:gap-5 sm:justify-center">
              <h1 class="font-bold text-xl text-primary sm:text-2xl md:text-4xl lg:text-5xl dark:text-slate-200">Hello! I am</h1>
              <p class="font-bold text-2xl text-primary sm:text-2xl md:text-5xl dark:text-slate-200">Agif <span class="text-logo-color">Ghifari M</span> </p>
              ...
              <div class="flex items-center gap-5">
                <a href="https://wa.me/085162761186" target="_blank" class="text-[32px] text-green-500">
                  <i class="fa-brands fa-square-whatsapp "></i>
                </a>
                <a href="https://www.instagram.com/cadisdmarshal" target="_blank" class="text-[32px] bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 text-transparent bg-clip-text">
                  <i class="fa-brands fa-square-instagram "></i>
                </a>
                <a href="#" target="_blank" class="text-[32px] text-logo-color ">
                  <i class="fa-brands fa-square-facebook"></i>
                </a>
                <a href="https://github.com/marshalexyz" target="_blank" class="text-[32px] text-primary dark:text-slate-200">
                  <i class="fa-brands fa-square-github "></i>
                </a>
              </div>
              <a href="https://wa.me/085162761186" target="_blank" class="self-start px-7 py-2 bg-primary text-white text-sm font-bold rounded-[8px] hover:bg-logo-color sm:px-10 sm:py-2 sm:text-lg dark:bg-logo-color dark:hover:bg-color-hover">Contact</a>
            </div>
            <div class="w-full flex items-center justify-center sm:justify-end ">
              <img class="rounded-full sm:W-[80%]" src="../assets/images/agif.png" alt="poto bintang">
            </div>
          </div>
        </div>
        <!-- hero end -->
