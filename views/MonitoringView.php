...
<html lang="en" class="">
  ...
  <body class="font-Poppins bg-color-bg dark:bg-dark-scondary lg:flex transition-all duration-150 ease-in-out">
      ...
      <div class="w-full h-3/4 flex flex-col justify-between px-[20px] sm:h-[75%] lg:h-[80%]">
        <ul class="w-full mt-5 grid grid-cols-1 gap-5">
          ...
          <li class="w-full bg-color-hover rounded-[4px] dark:bg-color-hover">
            <a href="MonitoringView.php" class="flex items-center gap-[20px] text-[14px] font-normal text-white px-3 py-2">
